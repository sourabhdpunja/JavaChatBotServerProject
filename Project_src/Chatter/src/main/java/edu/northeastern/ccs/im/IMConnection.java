...
//		bctMessage = Message.makeBroadcastMessage(userName, message);
//		socketConnection.print(bctMessage);
	}
    ...
    public void sendGroupModifyMessage(String line) {
		validateConnection();
		socketConnection.print(Message.makeGroupModifyMessage(userName, line));

    }
    
    public void sendSearchByAttributeMessage(String line) {
		validateConnection();
		socketConnection.print(Message.makeSearchByAttributes(userName, line));
    }
    
    public void sendRecallMessage(String line) {
		validateConnection();
		socketConnection.print(Message.makeRecallMessage(userName, line));

    }

    public void sendSubpoenaMessage(String line) {
		validateConnection();
		socketConnection.print(Message.makeSubpoenaMessage(userName, line));
	}
	...
	public void sendGroupMessage(String line) {
		validateConnection();
		socketConnection.print(Message.makeGroupMessage(userName, line));
	}


	public void sendDirectMessage(String line) {
		validateConnection();
		socketConnection.print(Message.makeDirectMessage(userName, line));
	}
}