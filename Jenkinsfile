...
agent any
 ...
 post {     
    success {
           slackSend (baseUrl: "https://cs5500.slack.com/services/hooks/jenkins-ci/", token: "HDxB3aCoHstWL2XVqH0H1Cq1", channel: "#cs5500-team-212-f18", color: '#00FF00', message: "SUCCESSFUL: Job '${env.JOB_NAME}")
            }
    failure {  
           slackSend (baseUrl: "https://cs5500.slack.com/services/hooks/jenkins-ci/", token: "HDxB3aCoHstWL2XVqH0H1Cq1", channel: "#cs5500-team-212-f18", color: '#FF0000', message: "FAILED: Job '${env.JOB_NAME}")
            }
       } //POST
} //PIPELINE
